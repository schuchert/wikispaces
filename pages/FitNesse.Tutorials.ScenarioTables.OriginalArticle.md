...
{% include include_md_file filename="sidebar_start.md" %}<span class="sidebar_title">Scenario Actors</span>
...
{% endhighlight %}
{% include include_md_file filename="sidebar_start.md" %}<span class="sidebar_title">Using Slim versus Fit in FitNesse</span>
...
{% include include_md_file filename="sidebar_start.md" %}<span class="sidebar_title">Scenario Names</span>
...
Attempt Logins To With And In Expecting 
{% endhighlight %}
%{ include_relative {% include include_md_file filename="sidebar_end.md" %}

{% include include_md_file filename="sidebar_start.md" %}<span class="sidebar_title"> Important! Scenario Parameter Matching</span>
...
{% include include_md_file filename="sidebar_start.md" %}<span class="sidebar_title">This is Just FitNesse</span>
