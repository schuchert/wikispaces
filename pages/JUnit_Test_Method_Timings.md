...
The first column is 10 digits wide and is the number of milliseconds to run the **test** method. It does NOT include the time to run setUp() and tearDown() (or their equivalent [@Before]({{ site.pagesurl}}/JUnit 4.xBefore) and [@After]({{ site.pagesurl}}/JUnit 4.xAtAfter) methods.)
