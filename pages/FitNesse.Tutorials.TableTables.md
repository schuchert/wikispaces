...
Notice that this borrows the Scenario table and script table from the [SetUp](http://localhost:8080/FrontPage.DigitalVideoRecorderExamples.ScenarioTableExamples.SetUp) page in the [[FitNesse.Tutorials.ScenarioTables|previous tutorial]]. In this tutorial, the only new table is a new Table Table to populate the program schedule. 
