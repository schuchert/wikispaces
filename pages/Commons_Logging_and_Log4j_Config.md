...
# # Log 4j
# Download log4j from [here](http://logging.apache.org/site/binindex.cgi|here]] (in my case, I downloaded the [[http://www.springframework.org/|Spring]] jar with dependencies from [[http://sourceforge.net/project/showfiles.php?group_id=73357&package_id=173644), which includes Log4j).
...
### Interesting Lines
||Line||Description||
||11 - 13||I'm using [PMD](http://eclipse-cs.sourceforge.net/|Checkstyle]] and [[http://pmd.sourceforge.net/integrations.html#eclipse). One of them has a rule that suggests classes with all static methods should have a private constructor to disallow instantiation.||
