...
[User Stories]({{ site.pagesurl}}/Monopoly Release 1 User Stories)
...
[User Stories]({{ site.pagesurl}}/Monopoly Release 2 User Stories)
...
[User Stories]({{ site.pagesurl}}/Monopoly Release 3 User Stories)
...
[User Stories]({{ site.pagesurl}}/Monopoly Release 4 User Stories)
...
[User Stories]({{ site.pagesurl}}/Monopoly Release 5 User Stories)
