...
---
### Define User Library
We need to add several jar files to the class path. We created a user library in [these steps]({{_site.pagesurl}}/JPA_Tutorial_1_-_Eclipse_Project_Setup#ClasspathVariables) and we're going to do the same thing with a different set of jar files.
