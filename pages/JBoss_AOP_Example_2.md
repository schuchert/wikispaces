...
---
[Next-->]({{ site.pagesurl }}/JBoss AOP Self Study|<--Back]] [[JBossAOPEX2ExpectedVersusActualOutput)

# Predict the Output
Source files are here: [here]({{ site.pagesurl }}/file:JBossAOPExample2src.zip]]. If you need instructions on what do with these files, try [[ExtractingSourceFilesIntoProject).
