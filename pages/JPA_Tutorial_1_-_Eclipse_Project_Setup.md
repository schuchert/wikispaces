...
# Start eclipse.
# When prompted, enter a directory for your workspace. I used C:\workspaces\JpaAndEjb3. To understand why I recommend not using a space in the name, read [this sidebar]({{_site.pagesurl}}/JPA_Tutorial_1_-_Getting_Started#SideBarJpaClassPath).
...
# Enter a project name: **JpaTutorial1**, again read [this sidebar]({{_site.pagesurl}}/JPA_Tutorial_1_-_Getting_Started#SideBarJpaClassPath) to know why I did not use a space in the project name.
