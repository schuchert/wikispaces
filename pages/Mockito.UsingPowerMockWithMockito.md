...
{:toc}
# Overview
Sometimes there's some low-level code, or badly written code, that makes verifying its behavior difficult. In this example, I'll show a few examples of mixing [Mockito](https://code.google.com/p/powermock/|PowerMock]] in with [[https://code.google.com/p/mockito/) to take control of:
* static methods
* calls to new
