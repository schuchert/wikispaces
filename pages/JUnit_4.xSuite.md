...
If you have added the suite method and at least one method with the [@Test]({{_site.pagesurl}}/JUnit_4.xAtTest) annotation, you are ready to run your first JUnit 4 test.
