...
If you review the [End Game]({{_site.pagesurl}}/Cxx_Tdd_Iteration_1#EndGame) section, you'll see the makefile I've been using that additionally includes targets for checking working with subversion.
