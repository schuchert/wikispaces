...
This tutorial is a derivative of one of the [JBoss tutorials](http://docs.jboss.org/ejb3/embedded/embedded-tutorial/mdb-standalone/) written using the embeddable container. In this tutorial we take the domain from [EJB3_Tutorial_4_-_Extended_Context]({{site.pagesurl}}/EJB3_Tutorial_4_-_Extended_Context) and add a new idea.
----
## The Requirements
